...
public class EnviarDadosDaPartidaParaLogTask extends AsyncTask<DadosPartidaParaOLog, String, String> 
{
	...
	private void inserirPalavrasTreinadasNoBD(
		...
		String url_selectInserirPalavrasTreinadas = "http://server.sumosensei.pairg.dimap.ufrn.br/app/inserir_palavras_treinadas_casual.php";//android nao aceita localhost, tem de ser seu IP
	...
	private void inserirCategoriasRegistroModoCasual(
		...
		String url_selectInserirCategoria = "http://server.sumosensei.pairg.dimap.ufrn.br/app/inserir_categorias_registro_partida_casual.php";//android nao aceita localhost, tem de ser seu IP
	...
	private String pegarIdUltimaPartidaInserida(String usernameJogador)
		...
		String url_pegar_id = "http://server.sumosensei.pairg.dimap.ufrn.br/app/pegar_id_partida_casual.php";

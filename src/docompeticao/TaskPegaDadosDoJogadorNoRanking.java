...
public class TaskPegaDadosDoJogadorNoRanking extends AsyncTask<String, Void, Void> 
{
	...
	public TaskPegaDadosDoJogadorNoRanking(ProgressDialog popupProgresso, TelaModoCompeticao telaModoCompeticao)
	{
		this.popupDeProgresso = popupProgresso;
		this.telaModoCompeticao = telaModoCompeticao;
	}
		 ...
		 try {
	            ...
	            if(jArray.length() > 0)
	            {
	            	for(int i=0; i < jArray.length(); i++) {
		            	...
		            	this.telaModoCompeticao.atualizarTituloJogador();
